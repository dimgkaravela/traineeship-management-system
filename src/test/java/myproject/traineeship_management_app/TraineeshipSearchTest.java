...
/**
 * Tests all three PositionSearchStrategy implementations plus PositionSearchFactory.
 */
...
//        assertThat(factory.getStrategy(SearchCriteria.INTERESTS)).isSameAs(interest);
//        assertThat(factory.getStrategy(SearchCriteria.LOCATION)).isSameAs(location);
//        assertThat(factory.getStrategy(SearchCriteria.BOTH)).isSameAs(combined);
//    }
